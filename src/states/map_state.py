...
class MapState(State):
    def __init__(self, game, player_data):
        ...
        # Personaje más grande (100x100) y posicionado sobre el camino
    ...
    def render(self, screen):
        ...
        pygame.draw.line(screen, (100, 100, 100), (0, 300), (800, 300), 15)
        ...
        # Render del personaje seleccionado (Más grande: 100x100)
        if "image" in self.player:
            img = pygame.transform.scale(self.player["image"], (100, 100))
            # Ajustamos el rect para que los "pies" estén sobre la línea
            rect = img.get_rect(midbottom=(self.player_pos[0], self.player_pos[1] + 10))
